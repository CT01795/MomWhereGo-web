...
Future<void> exportEventsToExcel(
    BuildContext context, List<Event> events, String isPlanned) async {
  final excel = Excel.createExcel();
  final sheet = excel['Sheet1'];

  sheet.appendRow([
    TextCellValue('活動名稱_______________________'),
    TextCellValue('關鍵字_______________________'),
    TextCellValue('縣市'),
    TextCellValue('地點____________________'),
    TextCellValue('費用 '),
    TextCellValue('開始日期__'),
    TextCellValue('開始時間'),
    TextCellValue('結束日期__'),
    TextCellValue('結束時間'),
    TextCellValue('描述______'),
    TextCellValue('相關單位'),
  ]);
  ...
  final filename =
      '${isPlanned}_events_${DateTime.now().millisecondsSinceEpoch}.xlsx';
